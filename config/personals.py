...
# Your legal name
first_name = "Tomás"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Agustín"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Friz"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "1131574246"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Capital Federal, Buenos Aires"                  # Los Angeles, San Francisco, etc.
'''
...
street = "Balbastro 821"
state = "Parque Chacabuco"
zipcode = "1424"
country = "Argentina"
...
ethnicity = "Latino"              # "Decline", "Hispanic/Latino", "American Indian or Alaska Native", "Asian", "Black or African American", "Native Hawaiian or Other Pacific Islander", "White", "Other"
...
gender = "Masculino"                 # "Male", "Female", "Other", "Decline" or ""
